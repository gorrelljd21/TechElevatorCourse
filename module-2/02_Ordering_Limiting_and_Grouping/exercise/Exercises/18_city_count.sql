...
SELECT state_abbreviation, COUNT(city_name) AS num_cities FROM city WHERE state_abbreviation NOT IN ('DC') GROUP BY state_abbreviation ORDER BY state_abbreviation;