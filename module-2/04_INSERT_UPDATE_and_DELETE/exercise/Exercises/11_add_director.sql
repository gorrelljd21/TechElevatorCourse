...
values ('Jessie Gorrell');

update movie set director_id = (select person_id from person where person_name = 'Jessie Gorrell') where title = 'The Blob';

--select * from person where person_name = 'Jessie Gorrell';
